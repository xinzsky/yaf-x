	...
	*/
		class Gek_Utils_Kses5
		{
			...
			public function __construct()
			{
				 ...
				 */
				$this->allowed_protocols = array('http', 'https', 'ftp', 'mailto');
			...
			{
                /* fixed bug: <img src=""/> => <img> */
                if(strcasecmp($element, 'img') == 0) {
                    $attr = rtrim($attr, '/');
                }
			 ...
			 *	@since PHP4 OOP 0.0.1
			 */
			public function removeBadProtocols($string)
			{
				$string  = $this->RemoveNulls($string);
